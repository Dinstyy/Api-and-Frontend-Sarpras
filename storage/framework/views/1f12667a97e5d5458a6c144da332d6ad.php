<?php $__env->startSection('title', 'Stock Manage'); ?>
...
<div id="pageContent" style="position: relative;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <form method="GET" class="filter-form">
            <input type="text" name="search" placeholder="Cari nama item..." value="<?php echo e(request('search')); ?>">
            <select name="type">
                ...
                <option value="damaged" <?php echo e(request('type') === 'damaged' ? 'selected' : ''); ?>>Rusak</option>
            </select>
            <input type="date" name="start_date" value="<?php echo e(request('start_date')); ?>">
            <select name="sort">
                <option value="item_asc" <?php echo e(request('sort') === 'item_asc' ? 'selected' : ''); ?>>Nama Item A-Z</option>
                <option value="item_desc" <?php echo e(request('sort') === 'item_desc' ? 'selected' : ''); ?>>Nama Item Z-A</option>
            </select>
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $movements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e(\Carbon\Carbon::parse($movement->movement_date)->format('Y-m-d H:i')); ?></td>
                        <td><?php echo e($movement->itemUnit->item->name ?? '-'); ?></td>
                        <td><?php echo e($movement->itemUnit->unit_code ?? '-'); ?></td>
    ...
    <div style="margin-top: 20px;">
        <?php echo e($movements->withQueryString()->links('pagination::bootstrap-4')); ?>
...
function openModal() {
    ...
    wrapper.innerHTML = `
        <div class="modal-overlay" onclick="closeModal(event)">
            <form action="<?php echo e(route('stock_movements.store')); ?>" method="POST" class="modal-form" onclick="event.stopPropagation()">
                <?php echo csrf_field(); ?>
                ...
                <div style="margin-bottom: 14px;">
                    ...
                    <select name="item_unit_id" required style="width: 100%;">
                        ...
                        <?php $__currentLoopData = $itemUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($unit->id); ?>"><?php echo e($unit->unit_code); ?> - <?php echo e($unit->item->name); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Sarpras\resources\views/stock_movements/index.blade.php ENDPATH**/ ?>