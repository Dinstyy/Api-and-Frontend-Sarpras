...
<?php $__env->startSection('content'); ?>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; margin-bottom: 16px;">
        <div>
            <a href="<?php echo e(route('users.create')); ?>" style="background: #722be0; color: white; padding: 10px 18px; border-radius: 6px; text-decoration: none; font-weight: 500; font-size: 14px;">
                + Tambah Pengguna
            </a>
            <form action="<?php echo e(route('users.import')); ?>" method="POST" enctype="multipart/form-data" style="display: inline-block;">
                <?php echo csrf_field(); ?>
        ...
        <div>
            <a href="<?php echo e(route('users.exportExcel')); ?>" style="background: #28a745; color: white; padding: 8px 14px; border-radius: 6px; text-decoration: none; font-size: 14px; margin-right: 8px;">
                Export Excel
            </a>
            <a href="<?php echo e(route('users.exportPdf')); ?>" target="_blank" style="background: #dc3545; color: white; padding: 8px 14px; border-radius: 6px; text-decoration: none; font-size: 14px;">
                Export PDF
            </a>
        </div>
    </div>
        ...
        <tbody id="user-table-body">
            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr style="border-bottom: 1px solid #2c2c2c;">
                    <td style="padding: 12px;"><?php echo e($users->firstItem() + $index); ?></td>
                    <td style="padding: 12px;"><?php echo e($user->name); ?></td>
                    <td style="padding: 12px;"><?php echo e($user->username ?? '-'); ?></td>
                    <td style="padding: 12px;"><?php echo e($user->email); ?></td>
                    <td style="padding: 12px;"><?php echo e($user->kelas ?? '-'); ?></td>
                    <td style="padding: 12px; text-transform: capitalize;"><?php echo e($user->role); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Sarpras\resources\views/users/index.blade.php ENDPATH**/ ?>